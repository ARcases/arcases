        ...
        <div class="history-block">
			...
			<div id="myLots" class="history-slide-items tab_content empty" style="display: block;line-height: 0px;padding: 0 100px 0 0;"><div class="empty"><span>Ник: '.$winnername.' | Шанс: '.$winnerpercent.'% | Выиграно:  '.round($winnercost,2).'$</span></div></div>
				...
				?> 
							...
							$rs = mysql_query("SELECT * FROM `games` WHERE `id` < $gamenum ORDER BY `id` DESC LIMIT 100");
							...
							$winneravatar = fetchinfo("avatar","users","steamid",$lastwinner);
							$winnername = fetchinfo("name","users","steamid",$lastwinner);						
							$idsteam = fetchinfo("steamid","users","steamid",$lastwinner);
							echo '
            ...
            <div class="availability-container">
                ...
                <p class="jslots">
                   <H3> <center><span>'.$winnername.'</span></center></H3>
                </p>
            </div>

            <div class="lottery-full-sidebar">
                <div class="lotAbout">
                    <div class="lotAboutTitle">Информация</div>
                     <ul>
					 <li>
             ...
             <div class="lottery-full-item-desc">
				<ul> 
						<a href="http://steamcommunity.com/profiles/'.$idsteam.'/" target="_blank" style="color:#A7B2B9;">Steamcommunity.com</a>
				</ul>
                </div>
            </div>
